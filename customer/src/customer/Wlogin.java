...
public class Wlogin extends JFrame {
	...
	SeatRemove seatRemove = new SeatRemove();
...
//panel2 회원가입화면
		...
		JButton btnSignUp_1_2 = new JButton("뒤로");
		btnSignUp_1_2.setForeground(Color.WHITE);
		btnSignUp_1_2.setFont(new Font("HY견고딕", Font.PLAIN, 20));
		btnSignUp_1_2.setBackground(new Color(0, 128, 255));
		btnSignUp_1_2.setBounds(945, 110, 176, 52);
		panel5.add(btnSignUp_1_2);

		btnSignUp_1_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panel5.setVisible(false);
				panel4.setVisible(true);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (uid1.equals("") || upass2.equals("")) {
					...
					try {
						...
						if (customer.logincheck(uid1, upass2) != null) {
							...
							dbUpdate.setNum(uid1);
							dbUpdate.dUpdate();
							idField6.setText("");

							PasswordField6.setText("");
							seatRemove.setNum(uid1);
							seatRemove.SelectSeat();
							System.out.println();
			...
			seatBtnn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (answer == JOptionPane.YES_OPTION) {
						...
						dbUpdate.setSeatNum(Integer.parseInt(seatBtnn.getText()));
						dbUpdate.sUpdate();
		...
		paymoney.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (answer == JOptionPane.YES_OPTION) {
					...
					dbUpdate.setTime((int) now.getHour());
					dbUpdate.stimeUpdate();
					panel7.setVisible(false);
				...
				if (uid.equals("") || upass.equals("")) {
					...
					try {
						...
						if (customer.logincheck(uid, upass) != null) {
							...
							lbWelcome.setText(customer.logincheck(uid, upass) + "님 환영합니다!");
