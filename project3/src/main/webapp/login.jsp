...
<header class="p-3 text-bg-dark">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="text-end">
          <button type="button" class="btn btn-outline-light me-2"><a href="login.jsp">Login</button>
          <button type="button" class="btn btn-warning"><a href="join.jsp">Sign-up</a></button>
        </div>
      </div>
    </div>
  </header>
